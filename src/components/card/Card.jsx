...
const Card = ({
  ...
  function sendedit() {
    alert(`Post ${title} with ID:${_id} has requested a name change`);
    fetch(`https://birdblogun-d42wh7ajma-vp.a.run.app/foroupload/${_id}`, {
      method: "PATCH",
    })
      .then(() => {
  ...
  return (
    <>
      {isEditVisible && <Edit onClose={handleCloseEdit} name={title} _id={_id}/>}
      <div className={`${styles.contcont} ${backgroundColorClass}`}>
        <div className={styles.container}>
          <div className={styles.titlecont}>
            <div className={styles.edit} onClick={handleShowEdit}></div>
